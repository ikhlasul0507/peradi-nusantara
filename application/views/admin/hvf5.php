            ...
            <main>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        $a = $this->db->query("SELECT nvt,jr_vt, SUM(nmvt) AS Total FROM tbl_vt5 WHERE jk_v=1 GROUP BY nvt ORDER BY Total DESC")->result_array();
                        $at = $this->db->query("SELECT SUM(nmvt) AS tall FROM tbl_vt5 WHERE jk_v=1")->result_array();
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        $ag = $this->db->query("SELECT nvt,jr_vt, SUM(nmvt) AS Totalg FROM tbl_vt5 WHERE jk_v=2 GROUP BY nvt ORDER BY Totalg DESC")->result_array();
                        $atg = $this->db->query("SELECT SUM(nmvt) AS tall FROM tbl_vt5 WHERE jk_v=2")->result_array();
                        $tag = $atg[0]['tall'];
