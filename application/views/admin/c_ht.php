<center><h3>Data Hasil Tes Online Peserta BGPOL</h3>
                                     <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" border="1" cellspacing="0" cellpadding="2">
