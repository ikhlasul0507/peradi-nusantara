         <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <?php  endif; ?>
                        <a href="<?= base_url('Admin/e_ht');?>" class="btn btn-danger mb-3">Export Excel</a>
                        <a href="<?= base_url('Admin/c_ht');?>" class="btn btn-warning mb-3 ml-3" target="_blank">Cetak</a><br>
                        <?php
                           ...
                           ?>
                           <b>Sedang Ujian</b><br>
                            <a href="<?= base_url('Admin/c_s');?>" class="btn btn-success mb-3 ml-3" >Close Soal</a>
                       <?php }else{ ?>
                            <b>Belum Ujian</b><br>
                            <a href="<?= base_url('Admin/o_s');?>" class="btn btn-success mb-3 ml-3" >Open Soal</a>
                       <?php } ?>
                        <div class="card mb-4">
