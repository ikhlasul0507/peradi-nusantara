         <div id="layoutSidenav_content">
                ...
                <script type="text/javascript">
                    ...
                    $('#example').DataTable({
                        ...
                        serverSide: false,
                        ajax: {
                            url: '<?= getAPI();?>SPK/Peserta/listPeserta?statusPeserta=1',
                            type: 'GET',
                        },
                        columns: [
                            { data: '_nm_p' },
                              ...
                              render: function ( data, type, row ) {
                                 if (row.id_byr === null) {
                                     return "<button onclick='buttonHapus("+row.id_p+")'>Hapus</button>"+
                                            "<b>|Belum Verifikasi Berkas|</b>";
                                 }else{
                                     if (row._st_soal === '2'){
                                        return "<button onclick='buttonHapus("+row.id_p+")'>Hapus</button>"+
                                            "<a href='<?= base_url('Admin/lihat/');?>"+row.id_p+"'>Lihat</a> <b>| Telah Verifikasi Berkas | Selesai Tes Online</b>"
                                     }else{
                                        return "<button onclick='buttonHapus("+row.id_p+")'>Hapus</button>"+
                                            "<a href='<?= base_url('Admin/lihat/')?>"+row.id_p+"'>Lihat</a> <b>| Telah Verifikasi Berkas</b>";
                                     }
                                 }
                              }
                            }
